...
# from dcs_memory.common.grpc_utils import retry_grpc_call # No longer used by SWM
...
class SharedWorkingMemoryServiceImpl(swm_service_pb2_grpc.SharedWorkingMemoryServiceServicer):
    def __init__(self):
        ...
        # Retry parameters are taken from self.config directly in the methods that need them.
